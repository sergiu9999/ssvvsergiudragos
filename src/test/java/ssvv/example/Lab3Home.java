...
public class Lab3Home
{
    ...
    public void tc_1_WBT(){
        String id = "";
        service.addTema(new Tema(id, "TC_1 Assignment", 12, 13));
    ...
    public void tc_2_WBT(){
        ...
        service.addTema(new Tema(id, "TC_2_WBT", 12, 16));

    }
    @Test(expected = ValidationException.class)
    public void tc_3_WBT(){
        var deadline = 15;
        service.addTema(new Tema("5", "TC_3 Assignment", deadline, 13));

    }
    @Test(expected = ValidationException.class)
    public void tc_4_WBT(){
        service.addTema(new Tema("5", "TC_4 Assignment", 12, 15));
    }
    @Test
    public void tc_5_WBT(){
        String id = "100";
        var assignment = service.addTema(new Tema(id, "TC_5 Assignment", 12, 13));
